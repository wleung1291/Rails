class ApplicationController < ActionController::Base
  ...
  # Logout function
  def logout!
    # Reset the session token. This will invalidate the old session token. 
    # We want to do that in case anyone has managed to steal the token; 
    # this will deny the thieves further access to the account.
